...
<html lang="en">
<head>
    <title>Code coverage report for src/Components/HorizontalTimelineButtons.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Components</a> HorizontalTimelineButtons.jsx
    </h1>
    <div class='clearfix'>
...
113
114
115</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
  ...
  &lt;ul &gt;
    &lt;li
      ...
      style={[
        ...
        props.position === 0 ? buttonStyles.inactive(props.styles) : <span class="branch-1 cbranch-no" title="branch not covered" >buttonStyles.active(props.styles),</span>
        { [Constants.LEFT]: 0 }
      ]}
    &gt;
    ...
    &lt;li
      ...
      style={[
        buttonStyles.link(props.styles),
        { [Constants.RIGHT]: 0 },
        p</span>rops.position === props.maxPosition ? <span class="branch-0 cbranch-no" title="branch not covered" >buttonStyles.inactive(props.styles) : buttonStyles.active(props.styles)
      ]}
    &gt;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Jul 23 2016 13:35:34 GMT+0530 (IST)
</div>
</div>
